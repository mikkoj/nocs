...
namespace Nocs
{
    ...
    public static class NocsService
    {
        ...
        private const string DocumentContentType = "text/html";
        ...
        public static Document SaveDocument(Document doc)
        {
            ...
            var updatedContent = Tools.FormatEditorContentToHtml(doc.Title, doc.Content);
        ...
        private static IWebProxy GetProxy()
        {
            ...
            if (!string.IsNullOrEmpty(Settings.Default.ProxyUsername) &&
                !string.IsNullOrEmpty(Settings.Default.ProxyPassword))
            {
                var proxyUsername = Settings.Default.ProxyUsername;
                var proxyPassword = Tools.Decrypt(Settings.Default.ProxyPassword);
